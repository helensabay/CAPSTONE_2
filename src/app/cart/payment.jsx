    ...
    if (method === "gcash") {
      ...
      setTimeout(async () => {
        try {
          ...
          if (res.success) {
            ...
            Alert.alert("Payment Failed", res.message || "GCash payment not confirmed.");
          }
        } catch (err) {
          setLoading(false);
      ...
      try {
        ...
        if (res.success) {
          ...
          Alert.alert("Payment Failed", res.message || "Cannot confirm counter payment.");
        }
      } catch (err) {
...
const styles = StyleSheet.create({
  ...
  successBox: { backgroundColor: "#fff", padding: 26, borderRadius: 24, alignItems: "center", width: "80%", shadowColor: "#000", shadowOpacity: 0.12, shadowRadius: 8, elevation: 5, borderWidth: 1, borderColor: "#e5e7eb" },
  checkCircle: { width: 90, height: 90, borderRadius: 45, backgroundColor: "#fff", justifyContent: "center", alignItems: "center", marginBottom: 16, borderWidth: 5, borderColor: "#22c55e", shadowColor: "#22c55e", shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  successTitle: { fontSize: 22, fontFamily: "Roboto_700Bold", color: "#16a34a", marginBottom: 10, textAlign: "center" },
  successMessage: { fontSize: 16, fontFamily: "Roboto_400Regular", color: "#374151", textAlign: "center", marginBottom: 15, lineHeight: 22 },
  divider: { width: "100%", height: 1, backgroundColor: "#e5e7eb", marginVertical: 10 },
  redirectText: { fontSize: 14, fontFamily: "Roboto_400Regular", color: "#6b7280", textAlign: "center" },
});

...
export default function OrderStatus() {
  ...
  const steps = ["Order Placed", "Order Accepted", "Preparing Order", "Completed"];
  ...
  if (loading) {
    return (
      <View style={[styles.container, { justifyContent: "center", alignItems: "center" }]}>
        ...
        <Text style={{ marginTop: 12, color: "#6b7280" }}>Loading order status...</Text>
      </View>
    );
  }
        ...
        {steps.map((step, index) => {
          ...
          return (
            <View key={index} style={styles.stepRow}>
              ...
              <Text
                style={[styles.stepText, { color: isActive ? "#b91c1c" : "#6b7280" }]}
              >
                {step}
              </Text>
            </View>
